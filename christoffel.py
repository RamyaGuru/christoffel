...
VOIGT = {00: 0, 11: 1, 22: 2, 12: 3, 21: 3, 0o2: 4, 20: 4, 0o1: 5, 10: 5} #Modified to the Python 3 octal numbers syntax
idmat = np.identity(3)
...
class Christoffel:
    ...
    def rotate_tensor(self, rot_mat=None, x_dir=None, z_dir=None):
        ...
        If no rot_mat is given, the tensor to align
    ...
    def set_direction_spherical(self, theta, phi):
        ...
        This calculated the christoffel matrix element by computing: qC_{ijkl}q
        """
        self.clear_direction()
